...
) ENGINE=InnoDB AUTO_INCREMENT=50968 DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `Abonetest` (
  ...
  PRIMARY KEY (`CId`),
  UNIQUE KEY `CId_UNIQUE` (`CId`)
) ENGINE=InnoDB AUTO_INCREMENT=50970 DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `Access_Details` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=16980528 DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `CInfo` (
  ...
  PRIMARY KEY (`Id`,`Mac`)
) ENGINE=InnoDB AUTO_INCREMENT=317514 DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `LogToDb` (
  ...
  KEY `Id` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=20524241 DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=152914 DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `radpostauth` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=803635 DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
/*!50003 CREATE DEFINER=`radius`@`%` PROCEDURE `SP_USER_EKLE0`(
...
/*!50003 CREATE DEFINER=`radius`@`%` PROCEDURE `SP_USER_EKLE1a`(
  IN k_tur INT,
