...
$pgtitle = array(gettext("5651log"), gettext("Certificate Manager"), gettext("Certificate Revocation"));
$pglinks = array("", "skl5651log_camanager.php", "skl5651log_crlmanager.php");
...
$tab_array = array();
$tab_array[] = array(gettext("Log View"), true, "/imzalar");
...
$tab_array[] = array(gettext("Certificate Revocation"), true, "skl5651log_crlmanager.php");
display_top_tabs($tab_array);
