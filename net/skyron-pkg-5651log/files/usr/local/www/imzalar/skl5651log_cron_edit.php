...
$tab_array = array();
$tab_array[] = array(gettext("Settings"), false, "/imzalar/skl5651log_cron.php");
if (empty($id)) {
	$tab_array[] = array(gettext("Add"), true, "/imzalar/skl5651log_cron_edit.php");
} else {
	$tab_array[] = array(gettext("Edit"), true, "/imzalar/skl5651log_cron_edit.php");
}
display_top_tabs($tab_array);
