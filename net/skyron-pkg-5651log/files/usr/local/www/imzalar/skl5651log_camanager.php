...
if ((!empty($act) &&
    ...
    !$thisca) ||
    (($act == 'del') && empty($_POST))) {
	pfSenseHeader("skl5651log_camanager.php");
	exit;
}
...
$pgtitle = array(gettext("5651log"), gettext("Certificate Manager"), gettext("CAs"));
$pglinks = array("", "skl5651log_camanager.php", "skl5651log_camanager.php");
...
?>
				<tr>
					...
					<td class="text-nowrap">
						<a class="fa fa-pencil"	title="<?=gettext("Edit CA")?>"	href="skl5651log_camanager.php?act=edit&amp;id=<?=$ca['refid']?>"></a>
						<a class="fa fa-certificate"	title="<?=gettext("Export CA")?>"	href="skl5651log_camanager.php?act=exp&amp;id=<?=$ca['refid']?>"></a>
					<?php if ($ca['prv']): ?>
						<a class="fa fa-key"	title="<?=gettext("Export key")?>"	href="skl5651log_camanager.php?act=expkey&amp;id=<?=$ca['refid']?>"></a>
					<?php endif?>
					<?php if (is_cert_locally_renewable($ca)): ?>
						<a href="skl5651log_certmanager_renew.php?type=ca&amp;refid=<?=$ca['refid']?>" class="fa fa-repeat" title="<?=gettext("Reissue/Renew")?>"></a>
					<?php endif ?>
					<?php if (!ca_in_use($ca['refid'])): ?>
						<a class="fa fa-trash" 	title="<?=gettext("Delete CA and its CRLs")?>"	href="skl5651log_camanager.php?act=del&amp;id=<?=$ca['refid']?>" usepost ></a>
					<?php endif?>
					</td>
				</tr>
<?php endforeach; ?>
...
$form = new Form;
//$form->setAction('skl5651log_camanager.php?act=edit');
if (isset($id) && $thisca) {
