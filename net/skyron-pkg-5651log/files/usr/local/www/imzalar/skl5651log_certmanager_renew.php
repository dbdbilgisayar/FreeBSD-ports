...
$pgtitle = array(gettext("5651log"), gettext("Certificate Manager"), gettext("Renew or Reissue"));
$pglinks = array("", "slk5651log_camanager.php", "@self");
...
$tab_array = array();
$tab_array[] = array(gettext("Daemon"), true, "/pkg_edit.php?xml=skl5651log.xml");
...
$tab_array = array();
$tab_array[] = array(gettext("CAs"), false, "skl5651og_camanager.php");
...
$tab_array[] = array(gettext("Renew or Reissue"), true, "skl5651log_certmanager_renew.php");
display_top_tabs($tab_array);
